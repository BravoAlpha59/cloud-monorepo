...
- **AWS Organization setup is fully applied (Phases 1–9, completed 2026-04-25).** Org/OUs/accounts, all three SCPs attached, DeploymentRole bootstrapped in prod, Identity Center + permission sets + account assignments, SSO profiles on WSL2, IAM billing access activated, multi-region CloudTrail trails in both member accounts. Authoritative status + applied IDs live in [infrastructure/org-setup/README.md](infrastructure/org-setup/README.md).
